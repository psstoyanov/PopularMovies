...
public class TestFetchMovieTask extends AndroidTestCase{
    static final String ADD_SORT_SETTING = "Sunnydale, CA";
        ...
        for ( int i = 0; i < 2; i++ ) {
            ...
            if (locationCursor.moveToFirst()) {
                ...
                assertEquals("Error: the queried value of location setting is incorrect",
                        locationCursor.getString(1), ADD_SORT_SETTING);
            ...
            long newLocationId = fwt.addsortOrder(ADD_SORT_SETTING);
            //long newLocationId = fwt.addLocation(ADD_SORT_SETTING, ADD_LOCATION_CITY,
            //        ADD_LOCATION_LAT, ADD_LOCATION_LON);
